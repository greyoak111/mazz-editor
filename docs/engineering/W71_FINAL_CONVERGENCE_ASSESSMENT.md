...
> [!NOTE]
> 跨波次未尽项、Factory 后半场、W64/W69/W70/W82–W86 Design Capsule 与 W72–W86 Post-W71 分组统一维护在 [`Mazz 当前未落地全景-W71归并版.md`](<C:/Users/Administrator/Downloads/交付区/Mazz 当前未落地全景-W71归并版.md>)。本评估仍只作为 W71 第一阶段审计证据，不承担未来路线真源。

> [!NOTE]
> 历史“80 分战略”只代表功能扩张期的资源配置，不是 Electron/Windows 平台能力的最终验收上限。垂直功能深度可以取舍；平台生命周期、原生集成、数据正确性和发布证据不能以“够用”豁免。当前执行口径见施工规格 3.5、6.4 与 8.7。
