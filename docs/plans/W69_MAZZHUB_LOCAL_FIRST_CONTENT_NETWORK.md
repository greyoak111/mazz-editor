...
> 登记日期：2026-08-15
> 原始材料：维护者《MazzHub 内容生态升格纲要》
> 原始 SHA-256：`089FD81DDFC5F07829199F9A7DCA6250E4AC902E1E92F4FEFDAD46EF15837195`
...
W69 的四根骨头不能替代内容站最低闭环。W69 必须按阶段补齐：
...
| W66 Agent Harness | 可执行发布/维护任务的受控能力 | Provider/Agent 不成为 Creator 身份 |
| W68/W73 Factory | 本地生产与审校事实层 | Hub 不另造 Factory |
| W72 Asset/Capability | Publication/World 的身份、来源与能力前件 | 不建 Universal Asset DB |
| W74c Promotion | Private → Public 的唯一显式闸 | 不自动公开工作区 |
...
| W81 Event Ledger | 私有个人工作运行史 | 不把个人行为默认投影到 Hub |
...
## 8. 两个早期 Hard Validation Samples

W69 不能以页面数量结案。最早必须跑通两个端到端样本：
...
A 证明 Content Fabric，B 证明 World Network。二者未跑通前，不得宣称 MazzHub 已升格成 Local-first Content Network。
...
> MazzHub 是建立在本地创作环境之上的公共内容网络：用户可以生产作品、公开作品、分享可继续创作的世界，让其他用户消费、Fork、衍生和再发布；Charts 提供透明的公共发现坐标，Factory 提供生产能力，原作者保留 Canon 定义权，P2P 与本地节点共同承担内容分发。

压缩定义：

> 不是只分享作品，而是分享作品、世界和继续创造它们的能力。
...
未经独立授权不得建设 Hub 服务、账号系统、中心数据库、P2P daemon、公共 Seed、World runtime、排行榜或正式入口。
