...
| W93f · Torrent Book Transport · **PASS** | Torrent inspect、选择性文件、持久恢复；协议、路径、Tracker 与 P2P 告知收紧 | [W93F 规格](../engineering/W93F_TORRENT_BOOK_TRANSPORT_SPEC.md)、独立书库 Torrent transport、持久 Acquisition/Inbox、资源页入口、[检查点](../engineering/W93F_TORRENT_BOOK_TRANSPORT_CHECKPOINT_2026-08-25.md)、[证据](../engineering/evidence/W93F_LIBRARY_TORRENT_TRANSPORT.json) | public-DHT magnet 严格解析、metadata `deselect:true`、只选单书、P2P/用户自有双确认、pause/restart/Inbox/书架完成 Source + Packaged fake-swarm E2E；实际公网 0；W93F 9/9、W93A 35/35、W93B 82/82、W93C 14/14、W93D 12/12、W93E 10/10、全量 270/270、build/dist/release/provenance/资源归零全绿；单 owner 冻结复核 CLEAR |
| W93g · Portability & Convergence · **PASS** | Workspace catalog 重建、迁移/重新定位、PDF Range、缓存治理与发布级封板 | [W93G 规格](../engineering/W93G_LIBRARY_RESOURCE_CONVERGENCE_SPEC.md)、portable catalog、完整 SHA 重绑、缺档同 bookId 修复、严格 PDF Range、派生缓存两阶段 GC、[检查点](../engineering/W93G_LIBRARY_RESOURCE_CONVERGENCE_CHECKPOINT_2026-08-25.md)、[证据](../engineering/evidence/W93G_LIBRARY_RESOURCE_CONVERGENCE.json)、[W93 总检查点](../engineering/W93_LIBRARY_RESOURCE_FREEDOM_FINAL_CHECKPOINT_2026-08-25.md) | Source + Packaged 均完成 Workspace 复制恢复、唯一改名重绑、进度/书签保留、PDF `206` 与派生缓存回收；W93G 12/12、W93A–F 相邻 162/162、默认全量 271/271、build/dist/release/provenance/隐私/资源终态全绿；W93 完成 |
...
10. **审计裁决**：冻结树审查必须明确 `CLEAR` 才进入下一波；审查采用独立 reviewer 或用户明确要求的单 owner 对抗复核，发现 P0/P1 则 `HOLD`。
