// tests/e2e/scenes67.mjs —— W58c 实证批 runner（scenes67 专用迭代器）
...
import { scenes67 } from './scenes67.mjs';
...
async function main() {
  ...
  await scenes67({ app, win, human, WS, WS2, scenario });
  ...
  console.log('═══════════');
  console.log(`W66实证批：${passed}/${results.length} 过`);
