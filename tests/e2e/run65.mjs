// tests/e2e/scenes65.mjs —— W58c 实证批 runner（scenes65 专用迭代器）
...
import { scenes65 } from './scenes65.mjs';
...
async function main() {
  ...
  await scenes65({ app, win, human, WS, WS2, scenario });
  ...
  console.log('═══════════');
  console.log(`W58b实证批：${passed}/${results.length} 过`);
