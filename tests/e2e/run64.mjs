// tests/e2e/scenes64.mjs —— W58c 实证批 runner（scenes64 专用迭代器）
...
import { scenes64 } from './scenes64.mjs';
...
async function main() {
  ...
  await scenes64({ app, win, human, WS, WS2, scenario });
  ...
  console.log('═══════════');
  console.log(`W59实证批：${passed}/${results.length} 过`);
