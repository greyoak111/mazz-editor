...
import { scenes73 } from './scenes73.mjs';
...
await scenes73({ app, win, human, WS, scenario, shotDir: SHOT_DIR });
...
console.log(`W59c实证批：${passed}/${results.length} 过`);
