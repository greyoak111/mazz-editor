// tests/e2e/run75.mjs —— W61a 多实例只读预览实证
...
import { scenes75 } from './scenes75.mjs';
...
const human = new Human(win, { tag: 'w61a' });
human.watchMain(app);
...
await scenes75({ app, win, human, WS, scenario, shotDir: SHOT_DIR });
...
console.log(`W61a实证批：${passed}/${results.length} 过`);
