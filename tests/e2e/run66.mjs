// tests/e2e/scenes66.mjs —— W58c 实证批 runner（scenes66 专用迭代器）
...
import { scenes66 } from './scenes66.mjs';
...
async function main() {
  ...
  await scenes66({ app, win, human, WS, WS2, scenario });
  ...
  console.log('═══════════');
  console.log(`W60v验货批：${passed}/${results.length} 过`);
