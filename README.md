[README.md](https://github.com/user-attachments/files/30157913/README.md)
# Mazz Editor
...
![版本](https://img.shields.io/badge/版本-v0.1.0-c8211b) ![平台](https://img.shields.io/badge/平台-Windows%20x64%20%7C%20x86%20%7C%20ARM64-1a1a1a) ![语言](https://img.shields.io/badge/界面语言-8%20种-4f46e5) ![内核](https://img.shields.io/badge/内核-Electron%2033-f0e6d2)
...
| --- | --- |
| <img width="1920" height="1030" alt="image" src="https://github.com/user-attachments/assets/1d90b126-1147-434f-818d-9b9c43c8c592" />| <img width="1922" height="1028" alt="image" src="https://github.com/user-attachments/assets/c5abfa0d-3c9f-4ac1-9772-a239b0dca28a" />|
...
| 文件 | 适用机型 | 说明 |
| --- | --- | --- |
| `mazz-editor-0.1.0-win-x64.zip` | 绝大多数 Windows 电脑（64 位 Intel/AMD） | 推荐 |
| `mazz-editor-0.1.0-win-ia32.zip` | 老旧 32 位 Windows | 集成终端不可用，其余正常 |
| `mazz-editor-0.1.0-win-arm64.zip` | Surface Pro X / 骁龙本（ARM64 Windows） | 全功能 |
| `mazz-editor-0.1.0-源码.zip` | 想自行构建/研究 | 完整源码 + 示例插件 |

绿色免安装：解压即用，无需管理员权限；如需开机自启/文件关联可在设置中开启。
