...
import factoryDeskModule from './modules/factory/desk.js';
...
modules.register('factorydesk', factoryDeskModule);
modules.register('organization', organizationModule);
modules.register('world', worldModule);
