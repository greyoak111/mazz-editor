...
export const AI_ROLES = Object.freeze([
  ...
  { id: 'factory_skeleton', label: '双环·骨架席 M1', card: 'reasoning' },
  { id: 'factory_writer', label: '双环·执笔席 M3', card: 'long-context' },
  { id: 'factory_point', label: '双环·对点席 M2', card: 'reasoning' },
  { id: 'factory_review_a', label: '双环·审理席 M4', card: 'long-context' },
  { id: 'factory_review_b', label: '双环·红队席 M5', card: 'reasoning' },
  { id: 'factory_arbiter', label: '双环·终审席 M6', card: 'reasoning' },
  { id: 'factory_polish', label: '双环·润色席', card: 'long-context' },
