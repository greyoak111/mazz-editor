...
function create(container) {
  ...
  root.innerHTML = `
    <style>
      .org-root{height:100%;overflow:auto;padding:22px;background:var(--bg,#171a21);color:var(--fg,#e5e7eb);font:14px/1.5 system-ui}.org-shell{max-width:1180px;margin:auto}.org-head{display:flex;gap:14px;align-items:end;flex-wrap:wrap;padding:18px;border:1px solid #394052;border-radius:12px;background:#20242e}.org-field{display:grid;gap:5px;min-width:180px;flex:1}.org-field.wide{flex:2}.org-field input,.org-field select{background:#151821;color:inherit;border:1px solid #485065;border-radius:7px;padding:9px}.org-actions{display:flex;gap:8px}.org-actions button{border:1px solid #6d72e8;background:#4d52c8;color:white;border-radius:7px;padding:9px 13px}.org-actions button.secondary{background:transparent}.org-preview{display:grid;gap:14px;margin-top:16px}.org-preview section{border:1px solid #343b4b;background:#1d212a;border-radius:10px;padding:16px}.org-preview h3,.org-preview h4{margin:0 0 9px}.org-badges{display:flex;gap:7px;flex-wrap:wrap}.org-badges span{border:1px solid #596179;border-radius:999px;padding:2px 8px}.org-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:9px}.org-grid article,.org-row{border:1px solid #343b4b;border-radius:8px;padding:10px;background:#191c24}.org-grid small,.org-grid code,.org-row small{display:block;color:#aab1c3;margin-top:4px}.org-columns{display:grid;grid-template-columns:1fr 1fr;gap:10px}.org-columns>div{display:grid;gap:7px}.org-empty{padding:40px;text-align:center;color:#aab1c3}@media(max-width:760px){.org-columns{grid-template-columns:1fr}}
    </style>
