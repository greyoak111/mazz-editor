...
const INVOKE_CHANNELS = new Set([
  ...
  'sync:positionPut', 'sync:positionGet', 'sync:positions', 'sync:positionsMerge', 'sync:stateFactPut', 'sync:stateFacts', 'sync:stateFactsMerge', 'sync:tempShare', 'sync:tempShareStop',
